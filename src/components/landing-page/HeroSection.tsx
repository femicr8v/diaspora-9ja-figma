...
export function HeroSection({ onGetStarted }: HeroSectionProps) {
  ...
  return (
    <section className="py-16 md:py-24 px-6 text-center bg-gradient-to-br from-background via-secondary/20 to-accent/5 relative overflow-hidden">
      <div className={`absolute inset-0 ${repeatingPlusPattern} opacity-50`} />
      ...
      <main className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col items-center gap-4 mb-8 md:mb-12">
          ...
          >
            ...
            <ArrowRight
              strokeWidth={2}
              className="ml-2 md:ml-3 size-5 md:size-6 -rotate-45 group-hover:rotate-0 group-active:rotate-0 transition-transform duration-300"
            />
          </Button>
        </div>
